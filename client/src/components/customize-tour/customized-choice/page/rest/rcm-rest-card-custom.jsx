...
export default class RcmRestCardCustom extends React.Component {
    ...
    render() {
        return (
            <div className={`rcm-main_card ${this.props.active ? "active" : ""} col col-12 col-sm-12 col-md-12`}>
                <div className="rcm-main_card-wrapper">
                    ...
                    <div className="rcm-main_card-info">
                        ...
                        <p className="contact" style={{ "margin-top": "5px" }}><i className="fa-solid fa-location-dot"></i>        {this.props.rest.address}</p>
                        <p className="contact"><i className="fa-solid fa-phone"></i>      {this.props.rest.telephone}</p>
