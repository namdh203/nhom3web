...
export default class RcmActCardCustom extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
    ...
    return (
      ...
      >
        <div className="rcm-main_card-wrapper">
          <img
            src={this.props.act.demoImage}
            className="img-fluid rcm-main_card-img act"
            alt="Responsive"
          />
          <div className="rcm-main_card-info">
            <div className="card-header">
              <h3 className="card-info_header">{this.props.act.name}</h3>
            </div>
            <p className="contact" style={{ marginTop: "5px" }}>
              <i className="fa-solid fa-heart-pulse"></i> {this.props.act.type}
            </p>
