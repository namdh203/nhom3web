                            ...
                            .map((trans) => (
                                <div className="custom-card col col-6 col-sm-6 col-md-3" onClick={() => {
                                    if (!this.state.activeList.includes(trans.transId)) {
                                        this.setState({ activeList: this.state.activeList.concat(trans.transId) }, () => {
                                            console.log("Active List: ", this.state.activeList)
                                        })
                                    } else {
                                        const index = this.state.activeList.indexOf(trans.transId);
                                        if (index !== -1) {
                                    ...
                                    <RcmTransCardCustom trans={trans} active={this.state.activeList.includes(trans.transId)}></RcmTransCardCustom>
                                </div>
                            ))}
                    </div>
