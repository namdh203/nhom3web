            ...
            <div className="card">
              <div className="d-flex flex-row justify-content-between mb-0 mt-3">
                <div className="d-flex flex-column mx-4">
                  <Title
                    level={1}
                    style={{ textAlign: "left", maxWidth: "60vw" }}
                  >
                    {name}
                  </Title>
                ...
                <div
                  className="d-flex flex-column text-end me-4"
                  style={{ marginTop: "4%" }}
                >
                  <Paragraph className="md-font-size m-0">
                    Price per night
                  </Paragraph>
              ...
              <div className="card p-4">
                ...
                {utilities.map((utility, index) => (
                  <Paragraph key={index} className="mb-2 md-font-size">
                    <span className="icon lg-font-size m-2">
                      <TiTickOutline />
                    </span>{" "}
                    {utility}
                  </Paragraph>
