  ...
  render() {
    ...
    return (
      <div className="profile-wrapper">
            ...
            <div className="row gx-5">
              <div className="col col-md-3 col-12 profile-avatar">
                ...
                <div className="profile-quick_info">
                  ...
                  <p>
                    Email:{" "}
                    {this.state.email !== null ? this.state.email : "None"}
                  </p>
                  <p>
                    Address:{" "}
                    {this.state.address !== null ? this.state.address : "None"}
                  </p>
                  <p>
                    CardNo:{" "}
                    {this.state.cardNo !== null ? this.state.cardNo : "None"}
                  </p>
                  <p>
                    Passport:{" "}
        ...
        <div
          className="choose-ava_wrapper"
          style={{ display: `${this.state.choose ? "block" : "none"}` }}
        >
          <div
            ...
            <div className="row">
              <div className="current-ava_wrapper col col-md-6 col-12">
                <div className="row gy-5">
                  <div
                    className="col col-md-12 col-12"
                    style={{
                      display: "flex",
                      alignItems: "center",
