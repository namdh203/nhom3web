    ...
    <div className="footer-wrapper">
      <div className="footer-info container-md">
        <div className="row g-5">
          <div
            className="col col-md-3 col-sm-12 col-12 footer-logo"
          ...
          >
            ...
            >
              Your ultimate travel companion! Personalized itineraries and smart
              destination recommendations make every journey unforgettable.
            </p>
