            ...
            <div className="rcm-accom_wrapper">
                        ...
                        <a href="#main">
                            <div className="nav-btn_wrapper">
                                <div className="nav-btn">
                                    <span>View all restaurants   <i className="fa-solid fa-angle-down"></i></span>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <div className="rcm-main" id="main">
                    <div className="searchBar">
                        ...
                        <input type="text" value={this.state.query} name="query" placeholder="Restaurant" onChange={this.onChange} />
                    </div>
