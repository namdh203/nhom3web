    ...
    return (
      <div className="rcm-accom_wrapper">
        ...
        <div className="rcm-banner">
          <img
            src="https://d1pk12b7bb81je.cloudfront.net/thumbor/lndbHoMuqXVkuSU_6fFL98IwGvY=/1920x910/https://d1pk12b7bb81je.cloudfront.net/images/photos/slideshows/1691513163_family-activities-photo-6.jpg"
        ...
        <div className="rcm-main" id="main">
          ...
          <div className="rcm-main_wrapper row gx-4 gy-5">
            {this.state.actData
              ...
              .map((act, index) => (
                <RcmActCard act={act} key={index}></RcmActCard>
              ))}
          </div>
        </div>
